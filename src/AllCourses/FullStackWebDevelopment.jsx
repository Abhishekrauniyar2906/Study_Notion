...
// import modules from "../AllCourses/CourseInfor/FullStackInfo";
...
//               <FaVideo className="text-green-400" /> <span>80+ Lectures</span>
//             </div>
...
//               This course takes you through full-stack development using the MERN stack, covering frontend (React.js), backend (Node.js + Express), databases (MongoDB), authentication, deployment, and more. It’s ideal for aspiring web developers and software engineers.
//             </p>
//           </div>
//         </div>
...
//           <img src={web} alt="Full Stack Course" className="w-full h-40 object-cover rounded-lg mb-4" />
//           <div className="flex items-center space-x-4 text-2xl font-bold mb-4">
//             <span className="text-[#38bdf8]">₹3500</span>
//             <del className="text-gray-400 mt-1 text-lg">₹7000</del>
//           </div>
//           <p className="text-white font-semibold mb-3">This Course Includes:</p>
//           <ul className="text-gray-300 font-semibold space-y-2 mb-4">
//             <li className="flex items-center"><SiTicktick className="text-green-400 mr-2" /> Project-based Learning</li>
//             <li className="flex items-center"><SiTicktick className="text-green-400 mr-2" /> 80+ hours Video Content</li>
//             <li className="flex items-center"><SiTicktick className="text-green-400 mr-2" /> MERN Stack Projects</li>
//             <li className="flex items-center"><SiTicktick className="text-green-400 mr-2" /> Interview Prep</li>
//           </ul>
    ...
    <div className="dark:bg-black min-h-screen px-4 text-white">
      <div className="max-w-6xl mx-auto py-10 flex flex-col md:flex-row gap-8">
        ...
        >
          ...
          <button className="w-full bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 cursor-pointer transition duration-300">Buy Now</button>
        </motion.div>
      </div>
