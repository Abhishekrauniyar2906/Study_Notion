...
// import modules from '../AllCourses/CourseInfor/JavaData'; // Ensure this is correctly imported
...
//               "This course dives into core Java concepts including object-oriented programming, exception handling, collections, file I/O, and multithreading.
//               Designed with hands-on coding and real-world problem-solving, it prepares you for Java-based interviews and development roles."
//             </p>
//           </div>
//         </div>
...
//             <span className="text-[#38bdf8]">₹2400</span>
//             <del className="text-gray-400 mt-1 text-lg">₹4000</del>
//           </div>
          ...
          <ul className="mt-4 space-y-4">
            {modules.map((module, idx) => (
              ...
              >
                ...
                {openModule === idx && (
                  <motion.ul
                    className="mt-2 ml-4 text-gray-300 list-disc space-y-1"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
